...
CPPPATH_NODE = '/Users/jlawson/local/node/include/node'
CPPPATH_ST = '-I%s'
CXX = ['/usr/bin/g++']
CXXDEFINES_ST = '-D%s'
CXXFLAGS = ['-g']
...
HAVE_EXPAT_H = 1
LIBDIR = '/Users/jlawson/local/node/bin'
LIBPATH_NODE = '/Users/jlawson/local/node/lib'
LIBPATH_ST = '-L%s'
LIB_EXPAT = ['expat']
LIB_ST = '-l%s'
LINKFLAGS_MACBUNDLE = ['-bundle', '-undefined', 'dynamic_lookup']
LINK_CXX = ['/usr/bin/g++']
NODE_PATH = '/Users/jlawson/local/node/bin'
PREFIX = '/usr/local'
PREFIX_NODE = '/Users/jlawson/local/node'
